				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"saml_certificate_set": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[ZeroTrustAccessIdentityProvidersSAMLCertificateSetDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"current_certificate": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[ZeroTrustAccessIdentityProvidersSAMLCertificateSetCurrentCertificateDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
