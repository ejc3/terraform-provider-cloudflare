...
type ZeroTrustOrganizationMfaConfigModel struct {
	...
	AmrMatchingSessionDuration types.String    `tfsdk:"amr_matching_session_duration" json:"amr_matching_session_duration,optional"`
	RequiredAaguids            types.String    `tfsdk:"required_aaguids" json:"required_aaguids,optional"`
	SessionDuration            types.String    `tfsdk:"session_duration" json:"session_duration,optional"`
}
...
type ZeroTrustOrganizationMfaPivKeyRequirementsModel struct {
	...
	SSHKeyType        *[]types.String `tfsdk:"ssh_key_type" json:"ssh_key_type,optional"`
	TouchPolicy       types.String    `tfsdk:"touch_policy" json:"touch_policy,optional"`
}
